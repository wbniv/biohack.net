...
- [verify] **2026-08-07-thailand-mobile-horizontal-calendar** — Verification section present but no PASS recorded — run + record the steps. _from [2026-08-07-thailand-mobile-horizontal-calendar.md](docs/plans/2026-08-07-thailand-mobile-horizontal-calendar.md)_  <!-- fp:d96f669d623e76aa -->
